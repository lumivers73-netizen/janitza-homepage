...
const products = [
  ...
  { badge: "Nejprodávanější", badgeColor: "bg-[#335EEC] text-white",   title: "UMG 96RM-E",     desc: "Multifunkční síťový analyzátor s Ethernet a RCM",   price: "od 18 500 Kč", image: "/UMG 96RM-E.png" },
          ...
          {products.map((product) => (
            <div key={product.title} className="product-card rounded-[4px] border border-gray-100 bg-white overflow-hidden flex flex-col">
              ...
              <div className="relative h-52 flex items-center justify-center bg-[#f5f7f7] overflow-hidden">
                ...
                />
                <button className="group absolute top-3 right-11 w-7 h-7 flex items-center justify-center rounded-full bg-white/80 text-[#5c5b5b] hover:text-[#335EEC] hover:bg-white transition-all shadow-sm" aria-label="Porovnat">
                  <IconScale size={15} stroke={1.5} />
                </button>
                <button className="absolute top-3 right-3 w-7 h-7 flex items-center justify-center rounded-full bg-white/80 text-[#5c5b5b] hover:text-[#335EEC] hover:bg-white transition-all shadow-sm" aria-label="Oblíbené">
              ...
              <div className="p-4 flex flex-col flex-1">
                ...
                <div className="mt-4 pt-3 border-t border-gray-100 flex items-center justify-between gap-2">
                  <span className="text-[1rem] font-semibold text-[#335EEC] whitespace-nowrap">
                    {product.price}
                  </span>
