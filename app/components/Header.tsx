      ...
      <div className="border-b border-gray-100">
        <div className="max-w-[1320px] mx-auto px-6 flex items-center h-[72px] gap-6">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center border border-gray-200 rounded-[3px] px-3 py-2 gap-2 focus-within:border-[#1488c9] transition-colors max-w-md">
          ...
          <a href="tel:+420777730002" className="flex-shrink-0 flex items-center gap-1.5 group">
            <IconPhone size={14} stroke={1.5} className="text-[#131313] group-hover:text-[#1488c9] transition-colors" />
            <span className="text-[13px] font-semibold text-[#131313] group-hover:text-[#1488c9] transition-colors whitespace-nowrap">
              +420 777 730 002
            </span>
          </a>
          <a href="#" className="flex-shrink-0 flex items-center gap-1.5 group">
            <IconMessageCircle size={14} stroke={1.5} className="text-[#131313] group-hover:text-[#1488c9] transition-colors" />
            <span className="text-[13px] font-semibold text-[#131313] group-hover:text-[#1488c9] transition-colors whitespace-nowrap">
              Online chat
            </span>
          </a>
          ...
          <div className="flex items-center gap-2 flex-shrink-0">
            ...
            <button
              className="relative p-1.5 text-white bg-[#1488c9] hover:bg-[#016399] transition-colors rounded-sm"
              aria-label="Košík"
            >
