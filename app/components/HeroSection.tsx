...
const categories = [
  ...
  { title: "Diferenční proudy (RCM)", desc: "Kontinuální sledování reziduálních proudů pro požární ochranu", image: "/varianta_C_66pct.png", cta: "Zobrazit RCM řešení", badge: "Ochrana proti poruchám", features: ["Požární ochrana", "Nepřetržité sledování", "Včasná detekce úniků", "Bezpečnost provozu", "Automatická signalizace"] },
